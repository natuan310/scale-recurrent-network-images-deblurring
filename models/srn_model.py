...
class DEBLUR(object):
    def __init__(self, args):
        ...
        self.data_list = open(os.path.join(ROOT_DIR, 'datalist_gopro.txt'), 'rt').read().splitlines()
    ...
    def load(self, sess, checkpoint_dir, step=523000):
    ...
    def test(self, H, W, input_path, output_path):
